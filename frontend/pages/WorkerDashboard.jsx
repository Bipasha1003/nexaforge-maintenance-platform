      ...
      <header className="site-header">
        <div className="site-brand">
          ...
          <div>
            ...
            <div className="site-subtitle">Welcome, {workerName || "team member"}</div>
          </div>
        </div>
        <nav className="site-nav">
          ...
          <button className="hero-btn hero-btn-primary" style={{ marginLeft: 8 }} onClick={() => setChatSignal((n) => n + 1)}>
            Ask assistant
          </button>
          <span className="site-nav-item site-nav-admin" onClick={handleLogout} style={{ cursor: "pointer" }}>
            Log out
          </span>
        </nav>
      </header>

      <main className="site-main" style={{ marginTop: 32 }}>
        <section id="overview">
              ...
              <section key={m.id} className="card fleet-tile">
                ...
                <div className="fleet-manual-row">
                  {m.manualReady ? (
                    ...
                    <span className="fleet-manual-missing">No manual uploaded yet for this machine</span>
                  )}
                </div>
              </section>
            ))}
